...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Best Things to Do Near Athens with Kids: Summer 2026 Guide", description: "The ultimate family activity guide for the Athens Riviera and Attica region." },
