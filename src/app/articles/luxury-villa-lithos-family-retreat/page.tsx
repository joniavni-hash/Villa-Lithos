...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Luxury Villa Near Athens: The Ultimate Family Retreat at Villa Lithos", description: "9 bedrooms, heated infinity pool, and space for 22 guests in Porto Rafti." },
