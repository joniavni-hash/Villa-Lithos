...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Porto Rafti Family Holiday: Why This Hidden Gem Beats the Greek Islands", description: "Discover why Porto Rafti is the smartest family holiday choice near Athens." },
