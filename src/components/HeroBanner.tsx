...
export default function HeroBanner({
  ...
  // On mobile: NO video at all (saves ~3MB payload, fixes LCP from 5.6s to ~1.5s)
  // On desktop: use desktop video source
  const currentVideoSrc = isDesktop
    ? (videoSrcDesktop || videoSrc)
    : undefined; // Mobile gets no video
    ...
    <section className="hv">
      ...
      <div className="hv-media">
        <div className="hv-media__inner">
          ...
          {/* Video overlays on top, fades in when ready - DESKTOP ONLY */}
          {showVideo && (
            <Video
              key={videoKey}
              ref={videoRef}
...
Video.displayName = "Video";"use client";
