      ...
      <div className="site-footer__container">
        ...
        <div className="site-footer__top">
          ...
          <div className="site-footer__brand">
            <span className="site-footer__brand-name">Villa Lithos</span>
          ...
          <div className="site-footer__links">
            ...
            <div className="site-footer__col">
              ...
              <nav className="site-footer__nav">
                <Link href="/#about">The Villa</Link>
                <Link href="/#services">Concierge</Link>
            ...
            <div className="site-footer__col">
              ...
              <div className="site-footer__contact-info">
                <a href="tel:+306932757142" className="site-footer__contact-link">
                  +30 693 275 7142
                </a>
                <a href="mailto:info@villalithos.com" className="site-footer__contact-link">
            ...
            {/* CTA Column */}
            <div className="site-footer__col site-footer__col--cta">
